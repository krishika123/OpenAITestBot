...
```
cd existing_repo
git remote add origin https://gitlab.cas.mcmaster.ca/capstone-project1/capstone-group-project.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.cas.mcmaster.ca/capstone-project1/capstone-group-project/-/settings/integrations)
